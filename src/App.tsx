...
function App() {
  ...
  const handleKeyDown = useCallback(
    ...
    [clipboard, isDeleteItemActive, selectedItem, pasteFromSelection, hideClipbox, setIsDeleteItemActive],
  );
        ...
        <div className="flex justify-between items-center mx-2">
          ...
          <div className="flex justify-right items-center">
            {actionsMenuItems.map((item) => (
              <div className="cursor-pointer p-1 rounded-md hover:bg-[#0a84ff]" onClick={item.onClick}>
